<form action="<?php echo e($url); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
    <?php echo csrf_field(); ?>
...
</form><?php /**PATH C:\laragon\www\Pertemuan2-PWF-149\resources\views/components/delete-button.blade.php ENDPATH**/ ?>