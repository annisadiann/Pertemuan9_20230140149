        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <div class="flex items-center gap-2 mb-6">
                    <a href="<?php echo e(route('category.index')); ?>" class="text-gray-400 hover:text-gray-600">‹</a>
                ...
                <form method="POST" action="<?php echo e(route('category.update', $category->id)); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $category->name)); ?>"
                            ...
                            dark:bg-gray-700 <?php $__errorArgs = ['name'];
...
<?php endif; ?><?php /**PATH C:\laragon\www\Pertemuan2-PWF-149\resources\views/category/edit.blade.php ENDPATH**/ ?>