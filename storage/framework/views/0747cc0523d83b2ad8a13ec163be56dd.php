                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-100">
                                    ...
                                    <td class="px-6 py-4"><?php echo e($category->products_count); ?></td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-3">
                                            ...
                                            <form method="POST" action="<?php echo e(route('category.delete', $category->id)); ?>" onsubmit="return confirm('Hapus kategori ini?')">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Pertemuan2-PWF-149\resources\views/category/index.blade.php ENDPATH**/ ?>